...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
                        ...
                        <table class="table display responsive nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{URL::to($row->image_one)}}" alt=""
            ...
            <a href="{{url('admin/payment/cancel/'.$order->id)}}" class="btn btn-danger btn-block">Order Cancel</a>
            @elseif($order->status == 1)
            <a href="{{url('admin/delevery/process/'.$order->id)}}" class="btn btn-info btn-block">Process Delevery</a>
            @elseif($order->status == 2)
            <a href="{{url('admin/delevery/done/'.$order->id)}}" class="btn btn-success btn-block">Delevery Done</a>
            @elseif($order->status == 4)
            <strong class="text-danger text-center">This order are not Valid</strong>
            @else   
            <strong class="text-success text-center">The product are successfully Delevered</strong>
            @endif
        </div>
